...
- Added a Docker Compose file with database support. Users can run the bot with a database, and if they don't set `DATABASE_URL` in `config.py`, it will automatically make an SQLite database.
